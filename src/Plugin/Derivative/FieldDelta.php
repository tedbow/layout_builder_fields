...
namespace Drupal\layout_builder_fields\Plugin\Derivative;
 ...
 * @internal
 */
class FieldDelta extends DeriverBase implements ContainerDeriverInterface {
  ...
  public function getDerivativeDefinitions($base_plugin_definition) {
    ...
    foreach ($this->entityFieldManager->getFieldMap() as $entity_type_id => $entity_field_map) {
      foreach ($entity_field_map as $field_name => $field_info) {
        ...
        //   Only trying to get paragraphs to work now.
        ...
        foreach ($field_info['bundles'] as $bundle) {
          ...
          // @todo Support field with limited cardinatliy.
